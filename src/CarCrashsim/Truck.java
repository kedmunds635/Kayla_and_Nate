...
public class Truck implements Car{
    ...
    public void spinAllParts(double dt) {
        ...
        spin(rVel * dt, getTruckBedPoints(), bed);
    }
    ...
    private ArrayList<Point> getTruckBedPoints() {
        ArrayList<Point> points = new ArrayList<>();
        points.add(new Point(LENGTH - 41, 4));
        points.add(new Point(LENGTH - 4, 4));
        points.add(new Point(LENGTH - 4, 41));
